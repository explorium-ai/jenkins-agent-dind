...
RUN \
    ...
    # install s6-overlay \
    export arch_org=$(arch | sed 's/ /_/g'/); \
    ${CURL} -o /tmp/s6-overlay-installer https://github.com/just-containers/s6-overlay/releases/download/v2.2.0.1/s6-overlay-${arch_org}-installer; \
